    ...
    <main class="h-full pb-16 overflow-y-auto">
        ...
        <div class="container px-6 mx-auto grid">
            <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                ...
                <a href="/admin/{{ $page['slug'] }}/create/" class="px-3 py-1 text-sm font-medium leading-5 text-white transition-colorsduration-150 bg-purple-600 border border-transparent
                        ...
                        @forelse($data as $datum)
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <a href="/admin/{{ $page['slug'] }}/edit/{{ $datum['id'] }}" class="px-3 py-1 text-sm font-medium leading-5 text-white transition-colorsduration-150 bg-purple-600 border border-transparent
                                rounded-md active:bg-purple-600hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                                        {{ __('Edit') }}
                                    </a>
                                </td>
